                    ...
                    >
                      ...
                      <div className="relative rounded-[30px] bg-white border border-slate-200 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_24px_70px_rgba(15,23,42,0.12)] hover:border-blue-200">
                        ...
                        <div className="px-5 pb-5 pt-1">
                          <h4 className="text-[13px] font-black text-slate-800 uppercase tracking-[0.12em] leading-[1.45] line-clamp-2 min-h-[38px] max-h-[38px] overflow-hidden transition-colors duration-300 group-hover/card:text-blue-600">
                            {p.name}
                          </h4>
                          ...
                          <div className="mt-3 flex items-center justify-between gap-3">
                            ...
                            <button
                              ...
                              className="h-11 px-4 rounded-full bg-slate-900 text-white flex items-center justify-center gap-2 text-[11px] font-black uppercase tracking-[0.16em] hover:bg-blue-500 hover:text-slate-900 transition-all shrink-0"
                            >
                              <ShoppingBag size={15} />
                              Add
                            </button>
