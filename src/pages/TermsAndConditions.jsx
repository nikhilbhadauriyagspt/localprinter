...
export default function TermsAndConditions() {
  ...
  ("Company," "we," "us," "our"), a company registered in Virginia, United States at 11872 Sunrise Valley Dr, Reston, VA 20191, USA.
      ...
      <p>
        We operate the website <a href="http://printerbrother.shop/">http://printerbrother.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
      </p>
      <p>
        PrinterBrother
  ...
  , concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
      ...
      <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@printerbrother.shop">info@printerbrother.shop</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p>Please review our Return Policy prior to making any purchases: <a href="http://printerbrother.shop/return-policy">http://printerbrother.shop/return-policy</a>.</p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-2 uppercase tracking-tighter">
          ...
          <p>Reston, VA 20191</p>
          <p>United States</p>
          <p className="pt-4 text-blue-600 font-black lowercase">Email: info@printerbrother.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
