        ...
        <div className="relative w-full px-4 md:px-8 lg:px-12">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1.02] text-slate-900">
              About <span className="text-blue-500">Local Printer</span>
            </h1>
            ...
            >
              <div className="rounded-[34px] border border-slate-200 bg-white p-7 md:p-10 shadow-[0_20px_60px_rgba(15,23,42,0.04)]">
                ...
                <h2 className="text-3xl md:text-4xl font-black tracking-tight leading-[1.08] text-slate-900 mb-5">
                  ...
                  <span className="block text-blue-500">simple and dependable.</span>
                </h2>
            ...
            >
              <div className="rounded-[34px] border border-slate-200 bg-gradient-to-br from-[#fff8eb] via-white to-[#f8fafc] p-7 md:p-8 h-full">
                ...
                <h3 className="text-2xl md:text-3xl font-black tracking-tight leading-[1.1] text-slate-900 mb-5">
                  Clear products.
                  <span className="block text-blue-500">Better experience.</span>
                </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
            {highlights.map((item, index) => (
              <motion.div
                ...
                className="rounded-[28px] border border-slate-200 bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-[0_18px_45px_rgba(15,23,42,0.06)]"
              >
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 border border-blue-200 text-blue-500">
                  {item.icon}
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
              <div className="lg:col-span-8 p-8 md:p-12">
                ...
                <h2 className="text-3xl md:text-4xl font-black leading-[1.08] text-white mb-4">
                  ...
                  <span className="block text-blue-400">everyday printing needs.</span>
                </h2>
              ...
              <div className="lg:col-span-4 p-8 md:p-12 flex flex-col justify-center gap-4 bg-white/5">
                <Link
                  to="/shop"
                  className="inline-flex items-center justify-center gap-3 rounded-full bg-blue-400 px-8 py-4 text-[11px] font-black uppercase tracking-[0.16em] text-slate-950 transition-all hover:bg-blue-300"
                >
                  Browse Products
                  <ArrowRight size={16} />
                </Link>
