...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This cookie policy explains howLocal Printer
        ("company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://localprinter.shop/">https://localprinter.shop/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@localprinter.shop">info@localprinter.shop</a></li>
      ...
      <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-1">
          <p className="text-slate-900">Local Printer</p>
          <p>2026 W Flagler St. Miami, FL 33135, USA</p>
          <p className="pt-4 text-cyan-600 font-bold">info@localprinter.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
