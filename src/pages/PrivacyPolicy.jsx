...
export default function PrivacyPolicy() {
  const email = "info@localprinter.shop";
  const emailLink = <a href={`mailto:${email}`} className="hover:underline text-cyan-600">{email}</a>;
  ...
  return (
    ...
    >
      <p className="lead">
        This Privacy Notice forLocal Printer ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:
      </p>
      <ul>
        <li>Visit our website at <a href="https://localprinter.shop/">http://localprinter.shop/</a> or any website of ours that links to this Privacy Notice</li>
        <li>Use Printers, Consumables & Accessories.Local Printer is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading printing brands.</li>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="https://localprinter.shop/cookie-policy">https://localprinter.shop/cookie-policy</a>.</p>
      ...
      <p>To exercise any of these rights, please contact us by {emailLink} or by visiting <a href="https://localprinter.shop/contact">https://localprinter.shop/contact</a>.</p>
      <h3>Appeals</h3>
